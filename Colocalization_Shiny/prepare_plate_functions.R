...
prepare_plate = function (name,file,to_order='',onlypuncta,norm='No'){
  ...
  if ('Yes' %in% onlypuncta){
      myImgResources2 <- paste0("imgResources/",name,"-sel-puncta-R_8-bit-",seq_len(384),".png")
      myImgResources <- paste0("imgResources/",name,"-sel-puncta_8-bit-",seq_len(384),".png")
    }
  else{
      myImgResources2 <- paste0("imgResources/",name,"-sel-R_8-bit-", seq_len(384), ".png")
      myImgResources <- paste0("imgResources/",name,"-sel_8-bit-",seq_len(384),".png")
    }
